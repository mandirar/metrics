function [ fuel_use ] = fuelUser_fun(metric,ems_mat,ek_constraint)
...
fuel_use = fmincon(@(fuel_use) -fuelUser_obj(fuel_use),guess,A,b,Aeq,beq,lb,ub,@(fuel_use) fuelUser_con(fuel_use,metric,ems_mat,ek_constraint),options);
