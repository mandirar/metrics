...
io_ICI45m45e = sum(max(rf_ICI45m45e(1:850) - 4.5,zero_vec45));
io_ICI45m45m = sum(max(rf_ICI45m45m(1:850) - 4.5,zero_vec45));
io_ICI45m45l = sum(max(rf_ICI45m45l(1:850) - 4.5,zero_vec45));
io_CCI45m45e = sum(max(rf_CCI45m45e(1:850) - 4.5,zero_vec45));
io_CCI45m45m = sum(max(rf_CCI45m45m(1:850) - 4.5,zero_vec45));
io_CCI45m45l = sum(max(rf_CCI45m45l(1:850) - 4.5,zero_vec45));
io_GWP45m    = sum(max(rf_GWP45m(1:850)    - 4.5,zero_vec45));
