% COMPARE_METRICSB calculates a family of five greenhouse gas emission,
% concentration, and radiative forcing scenarios for the hypothetical case
% where a metric is used to determine the amount of a pre-selected fuel 
% that can be used by the U.S. transportation sector without exceeding a 
% CO2-only emissions budget.
