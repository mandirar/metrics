...
if form == 1
    ...
    t1_B = 2015; %mitigation year B - 2015, 2021
    t1_C = 2020; %mitigation year C - 2020, 2030
    t1_D = 2025; %mitigation year D - 2024, 2040
    t1_E = 2025; %mitigation year E - 2028, 2049
end
